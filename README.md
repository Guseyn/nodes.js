...
```
2024-11-09T15:21:03.885Z - worker (pid:35119) - HTTP/2 server running at https://1.0.42.0:8004
2024-11-09T15:21:03.885Z - worker (pid:35120) - HTTP/2 server running at https://1.0.42.0:8004
```
...
const corsOptions = {
  allowedOrigins: [ '1.0.42.0:8004' ], // can also be just a string '*' (default)
